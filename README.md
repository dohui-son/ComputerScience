...
**_- [ ] 1. 디자인 패턴 10 가지 Design Pattern_**
**_- [x] 2. 프로그래핑 패러다임 Programming Paradigm_**
**_- [ ] 3. 네트워크 Network_**
**_- [ ] 4. 운영체제 Operating System_**
**_- [ ] 5. 데이터베이스 Database_**
**_- [ ] 6. 자료구조 Data Structures_**
**_- [ ] 7. 알고리즘 Algorithms_**
